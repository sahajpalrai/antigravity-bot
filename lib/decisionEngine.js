...
function _loadFloors() {
  try {
    if (fs.existsSync(_FLOORS_FILE)) {
      ...
      return {
        rth:          parseFloat(cfg.rthFloor)    || 0.60,
        eth:          parseFloat(cfg.ethFloor)    || 0.58,
        minPF:        parseFloat(cfg.minPF)       || 1.30,
        minSharpe:    parseFloat(cfg.minSharpe)   || 0.0,   // 0 = disabled until all models store sharpe
