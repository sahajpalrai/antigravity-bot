...
let portfolio = {
  accounts: {
    'NQ=F': { balance: INITIAL_BALANCE, peakEquity: INITIAL_BALANCE, drawdownFloor: INITIAL_BALANCE - DRAWDOWN_LIMIT, activePosition: null, status: 'Active', passed: false, mode: 'Evaluation', accountNumber: 'APX-NQ-50K-01' },
    'ES=F': { balance: INITIAL_BALANCE, peakEquity: INITIAL_BALANCE, drawdownFloor: INITIAL_BALANCE - DRAWDOWN_LIMIT, activePosition: null, status: 'Active', passed: false, mode: 'Evaluation', accountNumber: 'APX-ES-50K-02' },
    'CL=F': { balance: INITIAL_BALANCE, peakEquity: INITIAL_BALANCE, drawdownFloor: INITIAL_BALANCE - DRAWDOWN_LIMIT, activePosition: null, status: 'Active', passed: false, mode: 'Evaluation', accountNumber: 'APX-CL-50K-03' },
    'GC=F': { balance: INITIAL_BALANCE, peakEquity: INITIAL_BALANCE, drawdownFloor: INITIAL_BALANCE - DRAWDOWN_LIMIT, activePosition: null, status: 'Active', passed: false, mode: 'Evaluation', accountNumber: 'APX-GC-50K-04' }
  },
  history: []
};
...
function getPortfolioState() {
  ...
  for (const sym of Object.keys(portfolio.accounts)) {
    ...
    const unrealizedPnL = acc.activePosition ? acc.activePosition.unrealizedPnL : 0;
    ...
    enrichedAccounts[sym] = {
      ...
      unrealizedPnL,
      totalPnL: (realizedPnLBySymbol[sym] || 0) + unrealizedPnL
    };
  }
